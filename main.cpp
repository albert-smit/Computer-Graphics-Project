...
// UtilisEpour essayer différents types de rendu
// UtilisEvia le paramètre "-t" en ligne de commande
...
/**
 * Fonctions de gestion opengl Ene pas toucher
 */
// Actions d'affichage
// Ne pas changer
void display(void)
